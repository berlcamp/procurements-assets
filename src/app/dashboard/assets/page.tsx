        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {assetSummary.totalAcquisitionCost.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
            </div>
            <p className="text-xs text-muted-foreground">Active assets total cost</p>
          </CardContent>
        </Card>
